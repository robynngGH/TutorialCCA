...
public class LoanController {
  ...
  public Page<LoanDTO> findPage(@RequestParam(value = "idGame", required = false) Long idGame, @RequestParam(value = "idCustomer", required = false) Long idCustomer, @RequestParam(value = "date", required = false) Timestamp date,
